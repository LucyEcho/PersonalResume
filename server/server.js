...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-C2Xqiu9T.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-DDFDFkQR.js").then((n2) => n2.d);
